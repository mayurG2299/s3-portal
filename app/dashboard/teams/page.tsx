          ...
          <div className="glass-card !p-0 overflow-hidden animate-slide-up" style={{ animationDelay: '100ms' }}>
            <div className="p-6 border-b border-slate-100 dark:border-white/5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 dark:text-white tracking-tight">Active Members</h3>
          ...
          <div className="glass-card !p-0 overflow-hidden animate-slide-up" style={{ animationDelay: '150ms' }}>
            <div className="p-6 border-b border-slate-100 dark:border-white/5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 dark:text-white tracking-tight">Expand Workspace</h3>
              ...
              <Button
                variant="ghost"
                asChild
                className="h-8 px-3 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 hover:text-[#8c2bee] dark:hover:text-[#b673ff] border border-slate-200 dark:border-white/5"
              >
        ...
        <div className="space-y-8 lg:sticky lg:top-8 self-start animate-slide-up" style={{ animationDelay: '200ms' }}>
          ...
          <div className="glass-card !p-6 overflow-hidden relative">
            <div className="absolute top-0 right-0 p-4 opacity-10">
              <Info className="h-12 w-12 text-slate-900 dark:text-white" />
            </div>
            <h3 className="font-bold text-slate-900 dark:text-white tracking-tight mb-6 flex items-center gap-2">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="text-sm font-bold text-slate-900 dark:text-white tracking-tight bg-slate-50 dark:bg-white/5 px-3 py-2 rounded-lg border border-slate-200 dark:border-white/5">{team.name}</div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#8c2bee] to-violet-500 flex items-center justify-center text-[10px] font-black text-white border-2 border-white dark:border-slate-900 ring-2 ring-slate-100 dark:ring-white/5">
                    {team.owner?.name?.charAt(0) || 'A'}
                  </div>
                  <div className="min-w-0">
                    <p className="text-sm font-bold text-slate-900 dark:text-white tracking-tight truncate">{team.owner?.name || 'Owner'}</p>
