...
export async function GET(
  ...
  try {
    ...
    const previewUrl = file.bucket.cloudfrontDomain && file.bucket.cloudfrontKeyPairId
    ...
    await logUserAction({ request, action: 'FILE_PREVIEW_URL', success: false, errorMessage: error?.message || 'Internal server error' })
